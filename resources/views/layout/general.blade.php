...
<head>
    ...
    <title>Niños de los Andes</title>
...
<div class="footer-container">
    ...
    <div class="social-footer-container">
        <ul>
            <li><a href="https://www.facebook.com/FundacionNinosDeLosAndes"><img src="img/icons/facebook.png" alt="social icon"></a></li>
            <li><a href="https://www.instagram.com/funiandes/?hl=es-la"><img src="img/icons/instagram.png" alt="social icon"></a></li>
            <li><a href="https://twitter.com/ninandesmzls"><img src="img/icons/twitter.png" alt="social icon"></a></li>
        </ul>
    </div>
</div>

<div class="copyright-container">
    <p>Copyright por: ©2020 Fundación Niños de los Andes. Todos los derechos reservados.</p>
</div>
</body>
</html>
